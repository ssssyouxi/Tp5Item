...
Route::rule('News/:typedir/:id','news/news_article')->pattern(['id' => '\d+$']);
Route::rule('News/:typedir/:filename','news/news_article')->pattern(['filename' => '[0-9a-zA-Z-_]+']);
Route::rule('News/:typedir', 'news/news_list');
